package org.rixel.Core.main
{
	...
	public class RxStage_Old extends Sprite
	{
		...
		public function RxStage_Old(width:Number,height:Number, bgColor:uint = 0xFFFFFF, smoothing:Boolean = false, renderMode:String = RxStage_Old.BLIT_RENDERER)
		{
			super();
